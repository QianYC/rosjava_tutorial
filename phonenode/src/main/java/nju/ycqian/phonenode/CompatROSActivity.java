...
public abstract class CompatROSActivity extends AppCompatActivity {

    protected static final int MASTER_CHOOSER_REQUEST_CODE = 0;

    private final CompatROSActivity.NodeMainExecutorServiceConnection nodeMainExecutorServiceConnection;
     ...
     */
    private RosActivity.OnActivityResultCallback onActivityResultCallback = new RosActivity.OnActivityResultCallback() {
        @Override
                ...
                if (requestCode == MASTER_CHOOSER_REQUEST_CODE) {
                    ...
                    new AsyncTask<Void, Void, Void>() {
                        ...
                        protected Void doInBackground(Void... params) {
                            CompatROSActivity.this.init(nodeMainExecutorService);
                            return null;
                        }
                    }.execute();
                } else {
        ...
        public void onServiceConnected(ComponentName name, IBinder binder) {
            ...
            serviceListener = new NodeMainExecutorServiceListener() {
                ...
                public void onShutdown(NodeMainExecutorService nodeMainExecutorService) {
                    ...
                    // call finish() once.
                    if (!CompatROSActivity.this.isFinishing()) {
                        shutdownSignalReceived = true;
                        CompatROSActivity.this.finish();
                    }
                }
            };
     ...
     */
    protected CompatROSActivity(String notificationTicker, String notificationTitle) {
     ...
     */
    protected CompatROSActivity(String notificationTicker, String notificationTitle, URI customMasterUri) {
        super();
        this.notificationTicker = notificationTicker;
        this.notificationTitle = notificationTitle;
        nodeMainExecutorServiceConnection = new CompatROSActivity.NodeMainExecutorServiceConnection(customMasterUri);
    }
     ...
     * See {@link #setOnActivityResultCallback(RosActivity.OnActivityResultCallback)} for more information about
     ...
     */
    protected CompatROSActivity(String notificationTicker, String notificationTitle, Class<?> activity, int requestCode) {
     ...
     * in custom Activity constructor {@link #CompatROSActivity(String, String, Class, int)}.
